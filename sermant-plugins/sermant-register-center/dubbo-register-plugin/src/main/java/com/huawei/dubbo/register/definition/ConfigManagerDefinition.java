...
/**
 * ConfigManagerInterceptor增强类
 *
 * @author provenceee
 * @date 2022/1/13
 */
public class ConfigManagerDefinition implements EnhanceDefinition {
    private static final String ENHANCE_CLASS = "org.apache.dubbo.common.config.Environment";

    private static final String INTERCEPT_CLASS = "com.huawei.dubbo.register.interceptor.ConfigManagerInterceptor";

    private static final String METHOD_NAME = "setAppConfigMap";
