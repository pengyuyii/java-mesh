 ...
 * @date 2022/1/13
 */
public class ReportInstanceDefinition implements EnhanceDefinition {
    private static final String ENHANCE_CLASS = "org.apache.dubbo.metadata.report.MetadataReportInstance";

    private static final String INTERCEPT_CLASS = "com.huawei.dubbo.register.interceptor.ReportInstanceInterceptor";
